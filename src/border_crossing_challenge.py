...
#%%  
def border_crossing_challenge(input_file,output_file):
...
if __name__ == '__main__':
    if len(sys.argv)<2:
        print("Function usaage: python border_crossing_challenge,py ../input/border_crossing.csv ../output/report.csv")
        exit 
    ...
    border_crossing_challenge(input_file,output_file)
